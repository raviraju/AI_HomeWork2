...
void write_TraverseLogAB(ofstream& ofs,string nodeName,int nodeDepth,int nodeValue,int alpha,int beta)
{
	for(int d=0;d<nodeDepth;d++)
		cout << "\t";
	cout << nodeName << "," << nodeDepth << "," << nodeValue << "," << alpha << "," << beta << endl;
...
string H_MiniMax(ofstream& ofs,int** board, map<string,pair<int,int> >& pitNamePositionMap, map<pair<int,int>, string >& positionMancalaMap,map<int, set<string,pitComp> >& playerValidMovesMap, int noOfPits,int cutOfDepth,int playerNo)
{
	...
	cout << "First desiredAction : " << desiredAction << endl;
...
int H_MinValue(ofstream& ofs,string nodeName,bool nodeType,bool haveAnotherChance,int startPlayer,int** board,int noOfPits,int cutOfDepth,int playerNo,int curDepth,map<string,pair<int,int> >& pitNamePositionMap, map<pair<int,int>, string >& positionMancalaMap,map<int, set<string,pitComp> >& playerValidMovesMap)
{
	...
	if(checkGameOver(noOfPits, board, pitNamePositionMap))
	{
		...
		for(int d=0;d<curDepth;d++)
			cout << "\t";
		cout << "GAME OVER State, hence using computing EVAL of board : " << nodeValue << endl;
		write_TraverseLog(ofs,nodeName,curDepth,nodeValue);
		return nodeValue;
	}
	if(curDepth == cutOfDepth)
...
void MiniMax_Algo(ofstream& ofs_next_state,ofstream& ofs_traverse_log,int** board, map<string,pair<int,int> >& pitNamePositionMap, map<pair<int,int>, string >& positionMancalaMap,map<int, set<string,pitComp> >& playerValidMovesMap, int noOfPits,int cutOfDepth,int playerNo)
{
	...
	{
		cout << "DesiredAction :" << desiredAction << endl;
